...
<p>&nbsp;<p>
			<button id="technician1" onclick="changeValue(this)" style="width: 57; height: 26">
ଆୟତ</button>
&nbsp;&lt; &gt;&nbsp;
<button id="technician2" onclick="changeValue(this)" style="width: 57; height: 26">
ଆୟତ୍ତ</button>
&nbsp;
<font color="#FF3300">&nbsp;| </font>&nbsp;
<button id="technician3" onclick="changeValue(this)" style="width: 57; height: 26">
ମଧୁ</button>
		&nbsp;&lt; &gt;
<button id="technician4" onclick="changeValue(this)" style="width: 57; height: 26">
ମଧୂ</button>
		&nbsp;&nbsp;&nbsp; <font color="#FF3300">&nbsp;| </font>&nbsp;&nbsp;
<button id="technician6" onclick="changeValue(this)" style="width: 57; height: 26">
ପେଶା</button>
		&nbsp;&lt; &gt;&nbsp;
<button id="technician7" onclick="changeValue(this)" style="width: 57; height: 26">
ପେସା</button>
		&nbsp; &lt; &gt;
<button id="technician8" onclick="changeValue(this)" style="width: 57; height: 26">
ପେଷା</button>
		&nbsp;&nbsp;&nbsp;&nbsp; <font color="#FF3300">&nbsp;| </font>&nbsp;
<button id="technician9" onclick="changeValue(this)" style="width: 57; height: 26">
ପଲ୍ଲି</button>
		&nbsp; &lt; &gt;
<button id="technician10" onclick="changeValue(this)" style="width: 57; height: 26">
ପଲ୍ଲୀ</button>
		<p>
			<button id="technician11" onclick="changeValue(this)" style="width: 57; height: 26">
ରୁପା</button>
&nbsp;&lt; &gt;&nbsp;
<button id="technician12" onclick="changeValue(this)" style="width: 57; height: 26">
ରୂପା</button>
&nbsp;
<font color="#FF3300">&nbsp;| </font>&nbsp;
<button id="technician13" onclick="changeValue(this)" style="width: 57; height: 26">
ଋଷି</button>
		&nbsp;&lt; &gt;
<button id="technician14" onclick="changeValue(this)" style="width: 57; height: 26">
ରୁଷି</button>
		&nbsp;&nbsp;&nbsp; <font color="#FF3300">&nbsp;| </font>&nbsp;&nbsp;
<button id="technician15" onclick="changeValue(this)" style="width: 57; height: 26">
ମତ</button>
		&nbsp;&lt; &gt;&nbsp;
<button id="technician16" onclick="changeValue(this)" style="width: 57; height: 26">
ମତ୍ତ</button>
		&nbsp; &lt; &gt;
<button id="technician17" onclick="changeValue(this)" style="width: 57; height: 26">
ନିରବ</button>
		&nbsp; &lt; &gt;&nbsp;
<button id="technician18" onclick="changeValue(this)" style="width: 57; height: 26">
ନୀରବ</button>
		<p>
<button id="technician19" onclick="changeValue(this)" style="width: 57; height: 26">
ମଜା</button>
		&nbsp; &lt; &gt;&nbsp;
<button id="technician20" onclick="changeValue(this)" style="width: 57; height: 26">
ମଜ୍ଜା</button>
		<p>&nbsp;</div>
			</div>
		</div>
