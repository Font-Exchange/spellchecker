...
<p>&nbsp;<table border="1" width="100%" cellpadding="5">
	<tr>
		<td colspan="5">
			<button id="technician21" onclick="changeValue(this)" style="width: 57; height: 26">
ଆୟତ</button>
&nbsp;&lt; &gt;&nbsp;
<button id="technician22" onclick="changeValue(this)" style="width: 57; height: 26">
ଆୟତ୍ତ</button>
&nbsp;
</td>
		<td colspan="5">
<button id="technician23" onclick="changeValue(this)" style="width: 57; height: 26">
ମଧୁ</button>
		&nbsp;&lt; &gt;
<button id="technician24" onclick="changeValue(this)" style="width: 57; height: 26">
ମଧୂ</button>
		&nbsp; </td>
		<td colspan="5">
<button id="technician25" onclick="changeValue(this)" style="width: 57; height: 26">
ପେଶା</button>
		&nbsp;&lt; &gt;&nbsp;
<button id="technician26" onclick="changeValue(this)" style="width: 57; height: 26">
ପେସା</button>
		&nbsp; &lt; &gt;
<button id="technician27" onclick="changeValue(this)" style="width: 57; height: 26">
ପେଷା</button>
		</td>
	</tr>
	<tr>
		<td colspan="5">
<button id="technician28" onclick="changeValue(this)" style="width: 57; height: 26">
ପଲ୍ଲି</button>
		&nbsp; &lt; &gt;
<button id="technician29" onclick="changeValue(this)" style="width: 57; height: 26">
ପଲ୍ଲୀ</button>
		</td>
		<td colspan="5">
			<button id="technician30" onclick="changeValue(this)" style="width: 57; height: 26">
ରୁପା</button>
&nbsp;&lt; &gt;&nbsp;
<button id="technician31" onclick="changeValue(this)" style="width: 57; height: 26">
ରୂପା</button>
		</td>
		<td colspan="5">
<button id="technician32" onclick="changeValue(this)" style="width: 57; height: 26">
ଋଷି</button>
		&nbsp;&lt; &gt;
<button id="technician33" onclick="changeValue(this)" style="width: 57; height: 26">
ରୁଷି</button>
		</td>
	</tr>
	<tr>
		<td colspan="5">
<button id="technician34" onclick="changeValue(this)" style="width: 57; height: 26">
ମତ</button>
		&nbsp;&lt; &gt;&nbsp;
<button id="technician35" onclick="changeValue(this)" style="width: 57; height: 26">
ମତ୍ତ</button>
		</td>
		<td colspan="5">
<button id="technician36" onclick="changeValue(this)" style="width: 57; height: 26">
ନିରବ</button>
		&nbsp;&lt; &gt;&nbsp;
<button id="technician37" onclick="changeValue(this)" style="width: 57; height: 26">
ନୀରବ</button>
		</td>
		<td colspan="5">&nbsp;</td>
	</tr>
