...
$(document).ready(function() {
    $("#ucase").click(function() {
        $('#text-rows-to-columns-text').removeClass('text-capitalize');
        $('#text-rows-to-columns-text').val($('#text-rows-to-columns-text').val().toUpperCase());
		var $temp = $("<input>");
		$("body").append($temp);
		$temp.val($('#text-rows-to-columns-text').select());
		document.execCommand("copy");
		$temp.remove();
    });
    $("#lcase").click(function() {
        $('#text-rows-to-columns-text').removeClass('text-capitalize');
        $('#text-rows-to-columns-text').val($('#text-rows-to-columns-text').val().toLowerCase());
		var $temp = $("<input>");
		$("body").append($temp);
		$temp.val($('#text-rows-to-columns-text').select());
		document.execCommand("copy");
    ...
    $("#tcase").click(function() {
        $('#text-rows-to-columns-text').val($('#text-rows-to-columns-text').val().toLowerCase());
        $('#text-rows-to-columns-text').addClass('text-capitalize');
		var $temp = $("<input>");
		$("body").append($temp);
		$temp.val($('#text-rows-to-columns-text').select());
		document.execCommand("copy");
...
$(document).ready(function() {
    $('#text-rows-to-columns-text').keyup(function() {
...
$(document).ready(function() {
    $('#unicode').click(function() {
        var tstr = $("#text-rows-to-columns-text").val();
        var bstr = '';
        ...
        $("#text-rows-to-columns-text").val(bstr);
		var $temp = $("<input>");
		$("body").append($temp);
		$temp.val($('#text-rows-to-columns-text').select());
		document.execCommand("copy");
...
$(document).ready(function() {
    $('#encode').click(function() {
        var htmlcode = $("#text-rows-to-columns-text").val();
        var res = encodeURIComponent(htmlcode);
        $("#text-rows-to-columns-text").val(res);
		var $temp = $("<input>");
		$("body").append($temp);
		$temp.val($('#text-rows-to-columns-text').select());
		document.execCommand("copy");
...
$(document).ready(function() {
    $("#csvsplit").click(function() {
		if ($('#CSVInput').val() == "") {
			...
			var InputBox = $("#text-rows-to-columns-text").val();
		...
		$("#text-rows-to-columns-text").val(InputBox);
		}
    });
});
...
$(document).ready(function() {
    $("#addrule").click(function() {
        ...
        $("#text-rows-to-columns-text").val($("#text-rows-to-columns-text").val() + 'User-agent: ' + unam + '\n' + ueml + umsg + '\n\n');
		var $temp = $("<input>");
		$("body").append($temp);
		$temp.val($('#text-rows-to-columns-text').select());
		document.execCommand("copy");
...
$(document).ready(function() {
    $('#addxml').click(function() {
        ...
        $("#text-rows-to-columns-text").val($("#text-rows-to-columns-text").val() + 'Sitemap: ' + $("#xmlsitemap").val() + '\n\n');
        $('#text-rows-to-columns-text').select();
        return false;
    });
});
...
$(document).ready(function() {
    $('#mulwind').click(function() {
        var lines = $('#text-rows-to-columns-text').val().split(/\n/);
        var texts = [];
...
$(document).ready(function() {
    ...
    $("#genfeed").click(function() {
        $("#head_feed").val('<\?xml version="1.0" encoding="UTF-8"\?>' + '\n' + 
			...
			'			<link>' + $("#rss_website").val() + '</link>' + '\n' + 
			'		</image>' + '\n');
        $("#text-rows-to-columns-text").val($("#head_feed").val() + $("#pre_feed").val() + '	</channel>' + '\n' + '</rss>');
        $('#text-rows-to-columns-text').select();
    });
...
$(document).ready(function() {
    $("#genutm").click(function() {
        ...
        $("#text-rows-to-columns-text").val(gaurl + gacampaign + gasource + gamedium + gaterm + gacontent);
		var $temp = $("<input>");
		$("body").append($temp);
		$temp.val($('#text-rows-to-columns-text').select());
		document.execCommand("copy");
...
$(document).ready(function() {
    $("#wrptxt").click(function() {
        var lbn = $("#lnbrk").val();
        var text = $("#text-rows-to-columns-text").val(),
            text = text.replace(/(\r\n|\n|\r)/g, " "),
        ...
        $("#text-rows-to-columns-text").val(outputArray.join(""));
        $("#text-rows-to-columns-text").val($("#text-rows-to-columns-text").val().replace(' ', ''));
		var $temp = $("<input>");
		$("body").append($temp);
		$temp.val($('#text-rows-to-columns-text').select());
		document.execCommand("copy");
...
$(document).ready(function() {
    $("#txt2binary").click(function() {
        var txt = $("#text-rows-to-columns-text").val();
        var del = '';
        var len = txt.length;
        if (len == 0) return;
        var bin = '';
...
$(document).ready(function() {
    $("#binary2txt").click(function() {
        var bin = $("#text-rows-to-columns-text").val();
...
$(document).ready(function() {
    var len = $('#text-rows-to-columns-text').val().length;
	var lin = $('#text-rows-to-columns-text').val().split(/\r*\n/).length;
    var ch = len;
    var lc = lin;
    $('#mini_count').html('[' + ch + ']');
    $('#line_count').html('[' + lc + ']');
    ...
    $("#mini").click(function() {
        var text = $("#text-rows-to-columns-text").val(),
            ...
            text = text.replace(/ =/g, '='),
            text = text.replace(/	/g, '');
        $("#text-rows-to-columns-text").val(text);
		var $temp = $("<input>");
		$("body").append($temp);
		$temp.val($('#text-rows-to-columns-text').select());
		document.execCommand("copy");
