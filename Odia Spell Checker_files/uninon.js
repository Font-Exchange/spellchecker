...
function addEditMenu(word)
{
	...
	obj.innerHTML='<input type="button" value="Ignore" onclick="updateExitText()"><input type="text" style="width:100px;" id="editWord" value="'+word+'" /><input type="button" value="Change" background-color: #008CBA; onclick="updateExitText()" />';
